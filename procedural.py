...
if st.checkbox('gráfico: model1 x model2'):
    ...
    try:
        ...
        pp = plt.show()
        st.pyplot(pp)
        st.write('Mean Squared Error model1: ', mean_squared_error(y_test, prediction_inverse))
...
#st.subheader()
#if st.checkbox('Avaliação dos modelos das Máquinas Preditivas'):
        ...
        st.subheader("Avaliação com 'evaluate'")
